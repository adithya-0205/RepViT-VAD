...
print("=" * 60)
print("CONTINUAL LEARNING - ASSAULT")
print("=" * 60)
...
def create_datasets():
    ...
    if len(assault_train) == 0:

        raise RuntimeError(
            "Assault training dataset is empty."
        )

    if len(assault_val) == 0:

        raise RuntimeError(
            "Assault validation dataset is empty."
        )
